...
<ol>
  <li className="inline-content">
    ...
    <b>
      <Link to="/weaviate/configuration/rbac/manage-roles#requirements">
  ...
  <li className="inline-content">
    ...
    <b>
      <Link to="/weaviate/configuration/rbac/manage-roles#create-new-roles-with-permissions">
        new role
      </Link>
    </b>{' '}
    or an{' '}
    <b>
      <Link to="/weaviate/configuration/rbac/manage-roles#grant-additional-permissions">
        existing role
      </Link>
    </b>
    .
  ...
  <li className="inline-content">
    ...
    <b>Step 3.</b>{' '}
    <b>
      <Link to="/weaviate/configuration/rbac/manage-users#assign-a-role-to-a-database-user">
