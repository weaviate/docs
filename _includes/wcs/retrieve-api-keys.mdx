...
<div class="row">
  <ol>
    <li className="inline-content">
      Open the <Link to="https://console.weaviate.cloud">Weaviate Cloud console</Link> and <Link to="/docs/cloud/manage-clusters/status#select-your-cluster"> ssselect your cluster</Link>.
    </li>
    <li>
...
When using an official Weaviate [client library](/docs/weaviate/client-libraries), you need to authenticate using the `REST Endpoint`. The client will infer the gRPC endpoint automatically and use the more performant gRPC protocol when available.
