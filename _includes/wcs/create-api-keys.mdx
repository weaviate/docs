...
import Register from '/docs/cloud/img/weaviate-cloud-api-key-create.png';
...
import NewAPIKeyForm from '/docs/cloud/img/weaviate-cloud-api-key-create-form.png';
import SaveAPIKey from '/docs/cloud/img/weaviate-cloud-api-key-save.png';
  ...
  <div class="col col--6">
    <ol start="4">
      ...
      <li>
        ...
        <code>viewer</code>, or{' '}
        <Link to="/docs/cloud/manage-clusters/authorization">create a new role</Link> with
