For help with **Shared Cloud** and **Dedicated Cloud**, contact [Weaviate support](mailto:support@weaviate.io) directly to open a support ticket. To add a support plan, contact [Weaviate sales](https://weaviate.io/pricing#contact-sales).
