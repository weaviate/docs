For help with **Serverless Cloud**, **Enterprise Cloud**, and **Bring Your Own Cloud** accounts, contact [Weaviate support](mailto:support@weaviate.io) directly to open a support ticket.
