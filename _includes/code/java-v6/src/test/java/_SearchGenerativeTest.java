...
//     // highlight-start
//     String prompt = "Convert the following into a question for twitter. Include emojis for fun, but do not include the answer: {question}.";
//     // highlight-end

//     CollectionHandle<Map<String, Object>> jeopardy = client.collections.use("JeopardyQuestion");
//     // highlight-start
//     var response = jeopardy.generate.nearText(
//         // highlight-end
//         q -> q
//             .query("World history")
//             .limit(2),
...
//     // highlight-start
//     String prompt = "Convert this quiz question: {question} and answer: {answer} into a trivia tweet.";
//     // highlight-end
...
//     String srcImgPath = "https://images.unsplash.com/photo-1459262838948-3e2de6c1ec80?w=500&h=500&fit=crop";
//     HttpClient httpClient = HttpClient.newHttpClient();
//     HttpRequest request = HttpRequest.newBuilder().uri(URI.create(srcImgPath)).build();
//     HttpResponse<byte[]> imageResponse = httpClient.send(request, HttpResponse.BodyHandlers.ofByteArray());
//     String base64Image = Base64.getEncoder().encodeToString(imageResponse.body());
