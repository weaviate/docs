  ...
  themeConfig:
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          {
            html: '<div style="text-align:center;width:50vw;"><h1>Weaviate Docs Placeholder</h1></div>',
            // html: '<div style="display: inline-block; text-align:center; cursor:default;"><h1>Weaviate Docs</h1></div>',
            position: 'right',
            to: "docs/weaviate",
          },
          {
