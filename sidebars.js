...
const sidebars = {
  ...
  cloudSidebar: [
    ...
    {
      type: 'doc',
      id: 'cloud/connect', // document ID
      label: 'Connect to Weaviate Cloud', // sidebar label
    },
    {
      type: 'doc',
      id: 'cloud/sandbox', // document ID
      label: 'Sandboxes', // sidebar label
    },
    {
      type: 'category',
      label: 'Cloud tools & features',
      collapsible: true,
      collapsed: false,
      items: [
