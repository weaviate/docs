...
MESSAGE="{'text': 'Hey $AUTHOR_NAME - your :docusaurus: :weaviate-logo: website build (<https://github.com/weaviate/docs/tree/$branch_name|$branch_name>) is ready on Netlify:\n $NETLIFY_URL/docs/weaviate \n> $commit_message' }"
