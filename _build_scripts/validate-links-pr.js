...
const runPRValidationFromBuildDev = async () => {
    const validator = new LinkValidator({
        ...
        linksToSkip: [
            ...
            // NETLIFY REWRITE - 404s here by construction: this lane serves
            // ./build.dev from a plain static server that knows nothing about
            // netlify.toml. Not a blind spot - the rewrite target,
            // /specs/weaviate-openapi.json, is linked from the same page and is
            // checked normally. Verify this route with `netlify dev`.
            /^https?:\/\/[^/]+\/openapi\.json$/,
        ]
    }, Verbosity.ERROR);
