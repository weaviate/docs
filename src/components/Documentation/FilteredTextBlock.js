// src/components/Documentation/FilteredTextBlock.js
...
export const DOC_SYSTEMS = {
  py: {
    baseUrl: "https://weaviate-python-client.readthedocs.io/en/stable",
    constructUrl: (baseUrl, ref) => `${baseUrl}/${ref}`,
    icon: "/img/site/logo-py.svg",
  },
  pyv3: {
    baseUrl: "https://weaviate-python-client.readthedocs.io/en/v3.26.2",
    constructUrl: (baseUrl, ref) => `${baseUrl}/${ref}`,
    icon: "/img/site/logo-py.svg",
  },
  ts: {
  ...
  java: {
    baseUrl: "https://javadoc.io/doc/io.weaviate/client/latest/",
    constructUrl: (baseUrl, ref) => `${baseUrl}#${ref}`,
...
// Export function to extract filtered code
export const extractFilteredCode = (
  text,
  startMarker,
  endMarker,
  ...
  switch (language) {
    ...
    case "goraw":
      ...
      break;
    case "gonew":
      format = (input) => input.replace(/\t/g, "  ").replace(/^  /g, "");
      break;
    case "go":
      format = (input) =>
        input
