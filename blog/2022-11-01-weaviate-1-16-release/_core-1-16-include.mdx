...
For more information on how to use the `IsNull` filter, check out the [documentation](/docs/weaviate/api/graphql/filters#by-null-state).
...
For more information on how to filter by the property length, check out the [documentation](/docs/weaviate/api/graphql/filters#by-property-length).
...
Weaviate `1.16` unveils the [ref2vec-centroid](/docs/weaviate/modules/ref2vec-centroid) module! Ref2Vec is about representing a data object based on the objects it references. The `ref2vec-centroid` module uses the average, or centroid vector, of the cross-referenced vectors to represent the referencing object.
...
Check the [ref2vec-centroid](/docs/weaviate/modules/ref2vec-centroid) documentation to learn how to work with Ref2Vec.
...
Check the [/v1/nodes](/docs/weaviate/config-refs/nodes) documentation to learn how to use the `Node Status API`.
