...
Work on hybrid search is not over! We will continue to make improvements and introduce new features in the future. For example, there is already something in the [backlog](https://github.com/weaviate/weaviate/issues/2393) to add [`where` filters](/docs/weaviate/api/graphql/filters) to hybrid search (give it a thumbs up while you're there). 🙂
