...
For details, see [tenant activity statuses](/weaviate/manage-data/multi-tenancy#activate-tenant) and the [`s3-offload` module](/weaviate/configuration/modules#offload-s3-module).
