...
For details, see [tenant activity statuses](/docs/weaviate/manage-data/tenant-states#activate-tenant) and the [`s3-offload` module](/docs/weaviate/configuration/tenant-offloading#offload-s3-module).
