...
This feature is only available for self-hosted instances and Weaviate Enterprise Cloud. It is not available for [Weaviate Cloud](/docs/wcs) serverless instances.

For details, see [tenant activity statuses](/docs/weaviate/manage-data/multi-tenancy#activate-tenant) and the [`s3-offload` module](/docs/weaviate/configuration/modules#offload-s3-module).
