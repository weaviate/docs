...
ACORN can be enabled as the filter strategy by setting `filterStrategy` for the relevant HNSW vector index [in the collection configuration](/docs/weaviate/manage-data/collections#set-vector-index-parameters).
