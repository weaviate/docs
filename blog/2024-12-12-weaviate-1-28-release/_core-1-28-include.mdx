...
To learn more, check out our [Authentication](/docs/weaviate/configuration/authentication) and [Authorization and RBAC](/docs/weaviate/configuration/authorization) documentation, along with the [Roles](/docs/weaviate/configuration/roles) guide.
...
To use this feature, [set the deletion strategy at the collection level under replication settings](/docs/weaviate/manage-data/collections#replication-settings).
