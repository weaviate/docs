...
:::tip Read more:
- [Concepts: Data # Multi-tenancy](/docs/weaviate/concepts/data#multi-tenancy)
- [How-to manage data: Multi-tenancy operations](/docs/weaviate/manage-data/multi-tenancy)
:::
...
With `1.20` we’ve improved Product Quantization (PQ) by leaps and bounds and are officially taking it out of experimental mode! Originally PQ was introduced and released in `1.18` and we wrote about it [here](https://weaviate.io/blog/ann-algorithms-hnsw-pq).
...
:::tip Read more:
- [Concepts: Vector Indexing # Product Quantization](/docs/weaviate/concepts/vector-index#hierarchical-navigable-small-world-hnsw-index-with-product-quantizationpq)
- [How-to configure: Indexes # Vector index (see `pq`)](/docs/weaviate/config-refs/schema/vector-index)
:::
...
Please refer to [our documentation](/docs/weaviate/api/graphql/additional-operators#autocut) for more code examples, including for various Weaviate client libraries.
:::
...
It can be combined with all [vector search operators](/docs/weaviate/api/graphql/get#search-operators): `nearXXX`, `bm25`, and `hybrid`. `autocut` is placed after the operator, at the same level with `limit`/`offset`. It is disabled by default and can be explicitly disabled by setting its value to 0 or a negative number.

:::tip Read more:
- [GraphQL references: Additional operators # Autocut](/docs/weaviate/api/graphql/additional-operators#autocut)
- [How-to search: Similarity search # Autocut](/docs/weaviate/search/similarity#limit-result-groups)
- [How-to search: BM25 search # Autocut](/docs/weaviate/search/bm25#limit-result-groups)
- [How-to search: Hybrid search # Autocut](/docs/weaviate/search/hybrid#limit-result-groups)
:::
...
:::tip See our documentation for more examples
Please refer to [our documentation](/docs/weaviate/search/rerank) for more code examples, including for various Weaviate client libraries.
:::
...
This is just a first step in integrating ranking models with Weaviate. Read [our blog here](https://weaviate.io/blog/ranking-models-for-better-search) for further thoughts on this exciting space, and let us know what you want to see next 😉!

:::tip Read more:
- [Modules / Reranker-cohere](/docs/weaviate/model-providers/cohere/reranker)
- [Modules / Reranker-transformers](/docs/weaviate/model-providers/transformers/reranker)
- [How-to search: Reranking](/docs/weaviate/search/rerank)
:::
...
:::tip See our documentation for more examples
Please refer to [our documentation](/docs/weaviate/search/hybrid#change-the-fusion-methodd) for more code examples, including for various Weaviate client libraries.
:::
...
:::tip Read more:
- [GraphQL references: Search operators # hybrid](/docs/weaviate/api/graphql/search-operators#variables-2)
- [How-to search: Hybrid](/docs/weaviate/search/hybrid)
:::
...
The full list of metrics that are offered can be found [here](/docs/weaviate/configuration/monitoring#obtainable-metrics)
