...
- [How-to manage data: Multi-tenancy operations](/docs/weaviate/manage-collections/multi-tenancy)
:::
...
:::tip Read more:
- [Concepts: Vector Indexing # Product Quantization](/docs/weaviate/concepts/vector-index)
...
:::tip See our documentation for more examples
Please refer to [our documentation](/docs/weaviate/search/hybrid#change-the-fusion-method) for more code examples, including for various Weaviate client libraries.
:::
