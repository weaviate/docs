...
:::tip Read more:
- [Concepts: Data # Multi-tenancy](/weaviate/concepts/data#multi-tenancy)
- [How-to manage data: Multi-tenancy operations](/weaviate/manage-data/multi-tenancy)
:::
...
:::tip Read more:
- [Concepts: Vector Indexing # Product Quantization](/weaviate/concepts/vector-index#hierarchical-navigable-small-world-hnsw-index-with-product-quantizationpq)
- [How-to configure: Indexes # Vector index (see `pq`)](/weaviate/config-refs/schema/vector-index)
:::
...
Please refer to [our documentation](/weaviate/api/graphql/additional-operators#autocut) for more code examples, including for various Weaviate client libraries.
:::
...
It can be combined with all [vector search operators](/weaviate/api/graphql/get#search-operators): `nearXXX`, `bm25`, and `hybrid`. `autocut` is placed after the operator, at the same level with `limit`/`offset`. It is disabled by default and can be explicitly disabled by setting its value to 0 or a negative number.

:::tip Read more:
- [GraphQL references: Additional operators # Autocut](/weaviate/api/graphql/additional-operators#autocut)
- [How-to search: Similarity search # Autocut](/weaviate/search/similarity#limit-result-groups)
- [How-to search: BM25 search # Autocut](/weaviate/search/bm25#limit-result-groups)
- [How-to search: Hybrid search # Autocut](/weaviate/search/hybrid#limit-result-groups)
:::
...
:::tip See our documentation for more examples
Please refer to [our documentation](/weaviate/search/rerank) for more code examples, including for various Weaviate client libraries.
:::
...
:::tip Read more:
- [Modules / Reranker-cohere](/weaviate/model-providers/cohere/reranker)
- [Modules / Reranker-transformers](/weaviate/model-providers/transformers/reranker)
- [How-to search: Reranking](/weaviate/search/rerank)
:::
...
:::tip See our documentation for more examples
Please refer to [our documentation](/weaviate/search/hybrid#change-the-fusion-methodd) for more code examples, including for various Weaviate client libraries.
:::
...
:::tip Read more:
- [GraphQL references: Search operators # hybrid](/weaviate/api/graphql/search-operators#variables-2)
- [How-to search: Hybrid](/weaviate/search/hybrid)
:::
...
The full list of metrics that are offered can be found [here](/weaviate/configuration/monitoring#obtainable-metrics)
