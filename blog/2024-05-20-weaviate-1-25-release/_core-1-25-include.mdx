...
Some third part services offer more efficient, batch APIs. Starting in 1.25, you can configure Weaviate to [send batches of objects](/docs/weaviate/manage-data/import#batch-vectorization) to vectorization services that offer batch APIs.
...
[Multi-tenant collections](/docs/weaviate/manage-data/multi-tenancy) are a useful way to separate and organize data. Earlier version of Weaviate, [batch imports](/docs/weaviate/manage-data/import) already support multi-tenant operations. However, you have to create the tenants before you import data. This extra step can be inconvenient.

Starting in 1.25, you can configure Weaviate to [create new tenants](/docs/weaviate/manage-data/multi-tenancy#automatically-add-new-tenants)  during batch imports if the tenants don't already exist. Use automatic multi-tenant creation to streamline your data imports.
