...
Standalone vector searches use the [`nearText`](/docs/weaviate/search/similarity#search-with-text) and [`nearVector`](/docs/weaviate/search/similarity#search-with-a-vector) similarity operators to fine tune search results. Since [hybrid search](/docs/weaviate/search/hybrid) combines the strengths of vector search and keyword search, many of you asked for this feature in hybrid search too. It's here! The 1.25 release adds the [similarity operators](/docs/weaviate/search/hybrid#vector-similarity-search) to the vector component of hybrid search.
