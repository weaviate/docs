...
Standalone vector searches use the [`nearText`](/weaviate/search/similarity#search-with-text) and [`nearVector`](/weaviate/search/similarity#search-with-a-vector) similarity operators to fine tune search results. Since [hybrid search](/weaviate/search/hybrid) combines the strengths of vector search and keyword search, many of you asked for this feature in hybrid search too. It's here! The 1.25 release adds the [similarity operators](/weaviate/search/hybrid#vector-similarity-search) to the vector component of hybrid search.
