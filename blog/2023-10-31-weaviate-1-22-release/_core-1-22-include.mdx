...
If you are interested in the gRPC API, you can find the documentation including links to the proto files [on this page](https://weaviate.io/docs/weaviate/api/grpc).
