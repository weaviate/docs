...
If you are interested in the gRPC API, you can find the documentation including links to the proto files [on this page](https://weaviate-docs.netlify.app/docs/weaviate/api/grpc).
...
You may already have seen [a blog post](https://weaviate.io/blog/collections-python-client-preview) about this new client, but we are excited to announce that it is now available in beta!

The documentation can be found on [this page](/docs/weaviate/client-libraries/python)
