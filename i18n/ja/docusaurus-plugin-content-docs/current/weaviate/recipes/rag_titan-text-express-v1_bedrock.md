...
layout: recipe
toc: True
title: "AWS Bedrock での生成検索 (RAG)"
featured: False
integration: False
agent: False
tags: ['Generative Search', 'RAG', 'AWS']
---
[![Colab で開く](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/weaviate/recipes/weaviate-features/model-providers/aws/rag_titan-text-express-v1_bedrock.ipynb)
...
「単一結果」では、検索で得られた各結果ごとに生成を行います。 

以下の例では、ゾウに関する Jeopardy の質問から Facebook 広告を作成したいとします。 
...
「グループ化結果」では、検索で得られたすべての結果を基に 1 つの応答を生成します。 

以下の例では、動物に関する 2 件の Jeopardy の質問を取得し、それらから Facebook 広告を作成しています。 
