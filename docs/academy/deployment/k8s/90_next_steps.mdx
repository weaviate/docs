...
If you have replication configured, you can apply [tunable consistency](docs/deploy/configuration/replication.md) concepts to read/write operations as well as queries.
