...
If you have replication configured, you can apply [tunable consistency](/weaviate/configuration/replication.md) concepts to read/write operations as well as queries.
