...
There are many settings you can configure here. It may be beneficial to explore them in the `values.yaml` file, and review the relevant settings through the in-line comments, or in the [official Weaviate documentation](/weaviate/index.md) if you are curious.
...
See the [1.25 migration guide for Kubernetes](/weaviate/more-resources/migration/weaviate-1-25) for more details.
:::
