...
Weaviate can automatically [infer the schema](/weaviate/config-refs/collections.mdx#auto-schema) from the data. However, it's a good practice to define the properties explicitly, for better control and to avoid surprises.
