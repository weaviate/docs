...
If you are using WCD, generative modules are enabled by default ([see docs](/docs/wcs#configuration). Otherwise, you must configure your Weaviate instance to make sure that a generative module is enabled.
