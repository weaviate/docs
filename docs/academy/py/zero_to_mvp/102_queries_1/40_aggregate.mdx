...
The list of available properties can be found on [this page](/weaviate/api/graphql/aggregate.md#aggregate-syntax-and-query-structure) in our documentation.
:::
