...
The list of available properties can be found on [this page](/docs/weaviate/api/graphql/aggregate.md#aggregate-syntax-and-query-structure) in our documentation.
:::
...
import { varName } from './_quizData/40_aggregate.js';
