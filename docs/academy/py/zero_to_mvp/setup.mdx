...
If you haven't yet, create an OpenAI account, and create a [free API key here](https://platform.openai.com/api-keys).
...
The Weaviate Python client can run raw GraphQL queries. You can also use the [Weaviate Query app](/docs/cloud/tools/query-tool).
