...
If you are familiar with either solution and want to use them to install Weaviate now, see the documentation for [Docker-Compose](/deploy/installation-guides/docker-installation.md) or [Kubernetes](/deploy/installation-guides/k8s-installation.md).

### <i class="fa-solid fa-chalkboard"></i> Embedded Weaviate

We also have an experimental feature called [Embedded Weaviate](/deploy/installation-guides/embedded.md), where you can directly instantiate a Weaviate database from a client library.
...
- [Client libraries](/weaviate/client-libraries/index.mdx)
