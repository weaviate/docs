...
We also have an experimental feature called [Embedded Weaviate](docs/deploy/installation-guides/embedded.md), where you can directly instantiate a Weaviate database from a client library.
...
- [GraphQL API](/docs/weaviate/api/index.mdx)
