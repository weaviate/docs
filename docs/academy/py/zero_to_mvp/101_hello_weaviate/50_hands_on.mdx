...
The Weaviate API allows you to do quite a bit. We will try out some examples in the next sections. For more details, see the [API documentation](/docs/weaviate/api/index.md).
...
import { apiRecap, clientLimits } from './_quizData/50_hands_on.js';
