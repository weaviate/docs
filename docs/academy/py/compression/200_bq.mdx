...
[Binary quantization](/docs/weaviate/concepts/vector-quantization#binary-quantization) (BQ), is a technique used to compress vectors. In Weaviate, it can be used to reduce the size of the in-memory [HNSW index](/docs/weaviate/concepts/indexing/vector-index.md#hierarchical-navigable-small-world-hnsw-index) or the disk-based [flat index](/docs/weaviate/concepts/indexing/vector-index.md#flat-index).
