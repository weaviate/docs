...
You will need an OpenAI API key to follow along. If you don't have one, go to the [OpenAI website](https://openai.com/) and sign up for an account and create an API key.
