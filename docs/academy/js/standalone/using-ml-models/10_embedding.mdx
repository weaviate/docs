...
Lets walk through the process to configure embedding models in Weaviate and make a semantic search. We'll start by creating a free sandbox account on [Weaviate Cloud](https://console.weaviate.cloud/). Follow [this guide](https://weaviate.io/docs/wcs/connect) if you have trouble setting up a sandbox project.
