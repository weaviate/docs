...
Weaviate is open-source. In other words, its [codebase is available online](https://github.com/weaviate/weaviate) for anyone to see and use<sup>[(1)]#-notes)</sup>.
...
import { weaviateOpenSource, vectorSearchDefinition } from './_quizData/10_intro_weaviate.js';
