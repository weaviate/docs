...
We've covered that Weaviate is a [vector database](https://weaviate.io/blog/what-is-a-vector-database), and that a vector search is similarity-based. But, what is a vector?
...
import { howWeaviateWorks } from './_quizData/15_overview_vectors.js';
