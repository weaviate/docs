...
* [Deploy Weaviate from AWS Marketplace](docs/deploy/installation-guides/aws-marketplace.md)
* [Run embedding and generative models on SageMaker and Bedrock](/docs/weaviate/model-providers/aws)
