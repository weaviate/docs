...
Each user can have one (1) free cluster, and by default each organization can have up to **six (6)** Shared Cloud clusters. If you need more, [contact support](https://support.weaviate.io).
