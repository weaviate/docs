...
Yes. Go to the [Weaviate Cloud login page](https://console.weaviate.cloud/) and click the "Log in" button. Then, click **"Forgot Password"** and enter your email. You’ll receive a reset email at that address.
...
By default, each organization can have up to **six (6)** serverless clusters and **two (2)** sandbox clusters. If you need more, [contact support](mailto:support@weaviate.io).
