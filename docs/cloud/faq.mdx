...
By default, each organization can have up to **six (6)** Shared Cloud clusters and **two (2)** sandbox clusters. If you need more, [contact support](https://support.weaviate.io).
