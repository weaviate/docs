...
Yes. Go to the [Weaviate Cloud login page](/go/console?utm_source=docs&utm_content=cloud) and click the "Log in" button. Then, click **"Forgot Password"** and enter your email. You’ll receive a reset email at that address.
