...
Possibly. [Contact support](/support) to discuss custom provisioning or increased resource needs for your cluster.
...
Each user can have one (1) free cluster, and by default each organization can have up to **six (6)** Shared Cloud clusters. If you need more, [contact support](/support).

</details>

#### Q: Can I use GraphQL with Weaviate Cloud? {#graphql}
...
The Query tool was removed from the Weaviate Cloud console on **September 14, 2026**. Use the [Explorer tool](/cloud/tools/explorer-tool) to work with your data in the console instead.
...
Weaviate Cloud runs on **AWS** and **Google Cloud Platform (GCP)**.

Free clusters run on AWS. You can pick the AWS region under **Show advanced configuration** on the create-cluster form.

Shared Cloud clusters can choose which provider to use. Choose the provider and the region under **Show advanced configuration**.
