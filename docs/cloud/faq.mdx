...
The Query tool in the Weaviate Cloud console is also deprecated. Use the [Explorer tool](/cloud/tools/explorer-tool) to work with your data in the console instead.
