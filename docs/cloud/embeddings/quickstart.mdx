...
- A Weaviate Cloud free cluster running Weaviate `v1.28.5` and later
- A Weaviate client library that supports Weaviate Embeddings. Install a supported release:

<Tabs className="code" groupId="languages">
<TabItem value="py" label="Python">

```bash
pip install -U "weaviate-client>=4.9.5"
```
...
```bash
npm install weaviate-client@^3.2.5
```

</TabItem>
<TabItem value="java" label="Java">

The Java client supports Weaviate Embeddings. Install it as shown in the [client library page](/weaviate/client-libraries/java).

</TabItem>
<TabItem value="csharp" label="C#">

The C# client supports Weaviate Embeddings. Install it as shown in the [client library page](/weaviate/client-libraries/csharp).

</TabItem>
<TabItem value="go" label="Go">

The Go client does not support Weaviate Embeddings directly. Install it as shown in the [client library page](/weaviate/client-libraries/go), then pass the `X-Weaviate-Api-Key` and `X-Weaviate-Cluster-Url` headers manually upon instantiation, as shown below.
