...
After configuring the vectorizer, [import data](/docs/weaviate/manage-objects/import.mdx) into Weaviate. Weaviate generates embeddings for text objects using the specified model.
