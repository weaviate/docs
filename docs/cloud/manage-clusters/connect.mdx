...
[Weaviate Cloud (WCD)](/go/console?utm_source=docs&utm_content=cloud) offers multiple options on how to connect to your cluster:
...
1. Open the [Weaviate Cloud login page](/go/console?utm_source=docs&utm_content=cloud) in a browser.
...
1. Go to the Weaviate Cloud [login page](/go/console?utm_source=docs&utm_content=cloud).
