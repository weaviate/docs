...
<DocsImage
  ...
  caption="Connect to you Weaviate cluster with the Query tool"
  layout="right"
>
  {imageContent}
</DocsImage>
...
- [TypeScript/JavaScript](/docs/weaviate/client-libraries/typescript/typescript-v3#authentication)
