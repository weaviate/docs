...
Each Weaviate Cloud instance is automatically backed up by default. To restore a backup, [contact Weaviate Cloud support](https://console.weaviate.cloud/support).
