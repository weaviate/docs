...
2.  [Select your cluster](https://www.google.com/search?q=/cloud/manage-clusters/status%23select-your-cluster) and navigate to the `API Keys` section.
...
5.  You can also update the roles associated with this API key. Choose from the existing roles or [assign different roles](https://www.google.com/search?q=/cloud/manage-clusters/authorization).
