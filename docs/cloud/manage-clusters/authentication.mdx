...
1.  Open the [Weaviate Cloud console](/go/console?utm_source=docs&utm_content=cloud) and [select your cluster](/cloud/manage-clusters/status#select-a-cluster).
...
1.  Open the [Weaviate Cloud console](/go/console?utm_source=docs&utm_content=cloud).
...
<div class="row">
  <ol>
    <li className="inline-content">
      Open the{" "}
      <Link to="/go/console?utm_source=docs&utm_content=cloud">
