...
<div class="row">
  <div class="col col--6">
    ...
    <ul>
      <li>
        <a href="/docs/weaviate/config-refs/schema#auto-schema">
          <code>Enable auto schema generation</code>
        </a>
      </li>
      <li>
        <a href="/docs/weaviate/concepts/vector-index#asynchronous-indexing">
          <code>Enable async indexing</code>
        </a>
      </li>
      <li>
        <a href="/docs/weaviate/configuration/replication#async-replication-settings">
...
Weaviate Cloud clusters use API key authentication. The authentication approach depends on whether [RBAC (Role-Based Access Control)](/docs/weaviate/configuration/rbac) is enabled:
...
- **[Manage clusters: Authentication](/docs/cloud/manage-clusters/authentication.mdx)**
