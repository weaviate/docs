...
4.  Configure the `Advanced configuration` settings if needed.
...
1.  Select the `Serverless` tab.
2.  Choose a name for your cluster.
3.  Select a cloud region from the dropdown.
4.  Optionally, enable `High Availability` to reduce downtime during upgrades or scaling.
