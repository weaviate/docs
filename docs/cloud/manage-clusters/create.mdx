...
By default, an organization can have up to six (6) shared clusters and two (2) sandbox clusters at the same time. To change these limits, [contact support](https://support.weaviate.io).
