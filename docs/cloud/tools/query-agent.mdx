...
The **Weaviate Cloud (WCD) Query Agent** provides an interactive console for using the Weaviate [Query Agent](/agents/index.md), a pre-built agentic service designed to answer natural language queries based on the data stored in Weaviate Cloud.
