...
<div class="row">
    <div class="card">
        ...
        <div class="card__body">
            ...
            <br/>
            <p>Vectors are shown initially by its name where <Link to="/docs/weaviate/concepts/data#multiple-vector-embeddings-named-vectors">named vectors</Link> are used and number of dimensions. Expand the item further to see some of the vectors, or click `copy` (item <span class="callout">10</span>) to copy the entire vector to clipboard.</p>
        </div>
    </div>
</div>
<br/>
