...
import WCDQueryApp from '/docs/cloud/img/wcs-console-example-query.png';
...
import WCDConnectedInstances from '/docs/cloud/img/wcs-connected-instances.jpg';
...
import WCDInferenceApiKey from '/docs/cloud/img/wcs-console-inference-key.png';
...
import WCDManyInferenceApiKeys from '/docs/cloud/img/wcs-console-many-inference-keys.png';
