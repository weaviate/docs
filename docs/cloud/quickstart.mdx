...
Go to the [Weaviate Cloud console](/go/console?utm_source=docs&utm_content=cloud) and create a free Sandbox instance.
...
You can retrieve them both from the [WCD console](/go/console?utm_source=docs&utm_content=cloud) as shown in the interactive example below.
