...
<div class="row">
  <div class="col col--6">
    <ol start="5">
      <li>
        Open your authenticator application and scan the QR code (<span class="callout">4</span>).
      </li>
      <li>
        Enter the one-time code from your application (<span class="callout">5</span>).
      </li>
    </ol>
  </div>
  <div class="col col--6">
