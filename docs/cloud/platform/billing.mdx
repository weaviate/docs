...
To stop billing and service, delete all clusters in your account. This generates a final invoice with your latest usage charges, and billing stops after all clusters deletion.
