...
Weaviate offers three levels of support, [Standard](/docs/cloud/platform/support-levels#standard-support), [Professional](/docs/cloud/platform/support-levels#professional-support), and [Business Critical](/docs/cloud/platform/support-levels#business-critical-support). Each support plan has a billing rate for usage and a minimum cost per month.
