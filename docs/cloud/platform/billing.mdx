...
To estimate costs for different combinations of usage levels and support plans, see the [pricing calculator](https://weaviate.io/deployment/shared).
...
Weaviate offers three levels of support, [Standard](/cloud/platform/support-levels#standard-support), [Professional](/cloud/platform/support-levels#professional-support), and [Business Critical](/cloud/platform/support-levels#business-critical-support). Each support plan has a billing rate for usage and a minimum cost per month.
