...
import OrgSettings from '/docs/cloud/img/orgs-settings.jpg';
import OrgPulldown from '/docs/cloud/img/orgs-pulldown.jpg';
...
1. Ask the user for WCD account details.
   ...
   - If the user does not have an account, [create a new account](/cloud/platform/create-account).
