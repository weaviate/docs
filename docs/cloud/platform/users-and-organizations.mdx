...
**Organization settings** is where _Owners_ and _Admins_ can rename the organization, leave it, or delete it. You reach it from the [Overview page](/cloud/console-overview), where it is shown inline. The walkthrough below covers all three:
