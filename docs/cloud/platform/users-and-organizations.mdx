...
- To create a user account, follow [these steps](/docs/cloud/platform/create-account).
...
[Billing](/docs/cloud/platform/billing.mdx) is done on an organization level.
