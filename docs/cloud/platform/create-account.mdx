...
1. Delete all cluster(s) associated with your Weaviate email account.
2. Settle any remaining invoices.
3. Contact Weaviate Support Team with your email to request account deletion.
