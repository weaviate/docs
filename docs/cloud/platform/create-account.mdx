...
To delete your account from Weaviate, follow these steps:

1. Delete all clusters associated with your account to ensure you have no active cluster(s). This generates a final invoice.
2. Ensure all outstanding invoices are paid.
3. Contact Weaviate Support to request account deletion. Include your email address in your request.

Our support team will process your deletion request and remove your account data from our systems.
