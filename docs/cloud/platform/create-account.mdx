...
To delete your account from Weaviate Cloud:

1. Delete all clusters associated with your Weaviate Cloud account.
2. Settle any outstanding invoices.
3. Navigate to the [Account Page](https://console.weaviate.cloud/account).
