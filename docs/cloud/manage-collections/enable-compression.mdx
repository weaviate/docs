...
This guide shows you how to enable [vector compression](../../weaviate/concepts/vector-quantization.md) on existing collections in your Weaviate Cloud cluster. Compression reduces memory consumption while maintaining high recall.

:::tip Recommended: RQ 8-bit compression
We recommend [RQ 8-bit compression](../../weaviate/configuration/compression/rq-compression.md) for most use cases. It provides significant memory and storage savings with minimal recall impact, and should result in improved performance for most workloads.
:::
...
>
  <iframe
    id="yr4znlxblp"
    src="https://app.guideflow.com/embed/yr4znlxblp"
    width="100%"
    height="100%"
