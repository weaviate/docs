...
At this stage, there is a limit of 10,000 Transformation Agent operations per day per Weaviate Cloud [organization](/docs/cloud/platform/users-and-organizations.mdx#organizations).
