...
At this stage, there is a limit of 100 Query Agent queries per day per Weaviate Cloud [organization](/docs/cloud/platform/users-and-organizations.mdx#organizations).
