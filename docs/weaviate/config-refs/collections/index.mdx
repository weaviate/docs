...
| :-------------------- | :----- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `class`               | String | The name of the collection. See the [class](#class) section below for details.                                                                                   |
| `description`         | String | A description of the collection. See the [description](#description) section below for details.                                                                  |
