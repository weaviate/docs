...
| `REINDEX_SET_TO_ROARINGSET_AT_STARTUP` | Allow Weaviate to perform a one-off re-indexing to [use Roaring Bitmaps](../concepts/filtering.md#indexfilterable). <br/><br/>Available in versions `1.18` and higher. | `boolean` | `true` |
