...
| Parameter                                                                | Type   | Description                                                                                                                                                                                                                        | Default                 | Mutable       |
| :----------------------------------------------------------------------- | :----- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :---------------------- | :------------ |
| `vectorizer`                                                             | String | The name of the vectorizer module to use (e.g., `text2vec-cohere`). Set to `none` or `self provided` to disable auto-vectorization and provide vectors manually. [List of available model providers](../model-providers/index.md). | Module-specific default | No            |
| [`vectorIndexType`](./indexing/vector-index.mdx)                         | String | The type of vector index to use. Available values are `hnsw` (default), `flat`, or `dynamic`.                                                                                                                                      | `hnsw`                  | No            |
| [`vectorIndexConfig`](./indexing/vector-index.mdx)                       | Object | An object containing configuration settings specific to the chosen `vectorIndexType` (e.g., HNSW parameters like `ef`, `maxConnections`).                                                                                          | Index-specific defaults | Partially\*   |
...
| [↪ `vectorConfig.<name>.vectorIndexType`](./indexing/vector-index.mdx)   | String | The index type (`hnsw`, `flat`, etc.) for this specific named vector.                                                                                                                                                              | `hnsw`                  | No            |
| [↪ `vectorConfig.<name>.vectorIndexConfig`](./indexing/vector-index.mdx) | Object | The configuration for the index of this specific named vector.                                                                                                                                                                     | Index-specific defaults | Partially\*   |

\* See [vector index mutable parameters](./indexing/vector-index.mdx)<br/>
\*\* New [named vectors can be added](../manage-collections/vector-config.mdx#add-new-named-vectors) after collection creation

:::info Single vector vs multiple named vectors

- **For a simple setup with one vector per object:** You can use the top-level `vectorizer`, `vectorIndexType`, and `vectorIndexConfig` parameters.
