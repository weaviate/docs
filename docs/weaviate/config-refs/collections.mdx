...
| :--- | :--- | :--- | :--- | :--- |
| `maxWorkers` | Integer | Maximum number of concurrent async replication workers for this collection. Min: `1`, Max: `30` | `3` | `30` |
| `hashtreeHeight` | Integer | Height of the hash tree used for data comparison between nodes. Min: `0`, Max: `20` | `16` | `10` |
| `frequency` | Integer | Frequency of periodic data comparison between nodes, in seconds. | `30` | `30` |
| `frequencyWhilePropagating` | Integer | Frequency of data comparison after a propagation cycle did not complete, in milliseconds. | `10` | `10` |
| `propagationLimit` | Integer | Maximum number of objects propagated in a single iteration. Min: `1`, Max: `1000000` | `10000` | `10000` |
| `propagationDelay` | Integer | Delay before considering an object for propagation, in seconds. | `30` | `30` |
...
| `diffBatchSize` | Integer | Number of object metadata fetched per request during comparison. Min: `1`, Max: `10000` | `1000` | `1000` |
| `diffPerNodeTimeout` | Integer | Timeout for comparison response from a remote node, in seconds. | `10` | `10` |
| `propagationTimeout` | Integer | Timeout for a propagation request to a remote node, in seconds. | `30` | `30` |
| `loggingFrequency` | Integer | How often the async replication process logs its activity, in seconds. | `5` | `5` |
| `aliveNodesCheckingFrequency` | Integer | Frequency of checking node availability changes, in seconds. | `5` | `5` |
| `initShieldCPUEveryN` | Integer | Controls CPU shielding frequency during hash tree initialization. | `100000` | `100000` |
