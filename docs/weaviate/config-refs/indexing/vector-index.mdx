...
| Parameter      | Type    | Default | Mutable | Details                                                                                     |
| :------------- | :------ | :------ | :------ | :------------------------------------------------------------------------------------------ |
| `enabled`      | boolean | `true`  | No      | Enable RQ compression. RQ is mandatory and cannot be disabled for HFresh.                  |
| `bits`         | integer | `1`     | No      | Number of bits used for quantization of postings. Only `1` bit is supported for HFresh.    |
| `rescoreLimit` | integer | `350`   | Yes     | The minimum number of candidates to fetch before rescoring.                                |
