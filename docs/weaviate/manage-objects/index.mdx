...
export const objectCrudData = [
  {
    ...
    link: "/docs/weaviate/manage-objects/create",
  ...
  },
  {
    ...
    link: "/docs/weaviate/manage-objects/import",
  ...
  },
  {
    ...
    link: "/docs/weaviate/manage-objects/read",
    icon: "fas fa-eye",
  },
  {
    ...
    link: "/docs/weaviate/manage-objects/read-all-objects", 
    icon: "fas fa-list",
  },
  {
    ...
    link: "/docs/weaviate/manage-objects/update",
    icon: "fas fa-edit",
  },
  {
    title: "Delete objects",
    description: "Remove specific data objects from a collection.",
    link: "/docs/weaviate/manage-objects/delete",
