...
Find out more about error handling on the Python client [reference page](/docs/weaviate/client-libraries/python).
...
<!-- See the client page for additional batch import [configuration options](/docs/weaviate/client-libraries/python#batch-imports). -->
