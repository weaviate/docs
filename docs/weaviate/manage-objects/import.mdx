...
To maximize import speed, enable [asynchronous indexing](/weaviate/config-refs/vectorization.mdx#asynchronous-indexing).
...
- [Configuration: Indexes](/weaviate/config-refs/vectorization.mdx#asynchronous-indexing)
