...
The [TypeScript client v3](../client-libraries/typescript/index.mdx#batch-inserts) uses gRPC by default.
...
For details, see [auto-tenant](/docs/weaviate/manage-collections/multi-tenancy#automatically-add-new-tenants).
