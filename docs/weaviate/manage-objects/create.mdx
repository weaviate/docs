...
import GoV6Code from "!!raw-loader!/_includes/code/go-v6/manage_objects_test.go";
...
<Tabs className="code" groupId="languages">
  ...
  <TabItem value="go6" label="Go v6 (beta)">
    <FilteredTextBlock
      text={GoV6Code}
      startMarker="// START CreateWithVector"
      endMarker="// END CreateWithVector"
      language="go6"
    />
  </TabItem>
  <TabItem value="java" label="Java">
...
<Tabs className="code" groupId="languages">
  ...
  <TabItem value="go6" label="Go v6 (beta)">
    <FilteredTextBlock
      text={GoV6Code}
      startMarker="// START CreateWithId"
      endMarker="// END CreateWithId"
      language="go6"
    />
  </TabItem>
  <TabItem value="java" label="Java">
...
```
  ...
  <TabItem value="go6" label="Go v6 (beta)">
    <FilteredTextBlock
      text={GoV6Code}
      startMarker="// START CreateWithDeterministicId"
      endMarker="// END CreateWithDeterministicId"
      language="go6"
    />
  </TabItem>
  <TabItem value="java" label="Java">
