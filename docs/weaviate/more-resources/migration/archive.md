...
1. **Per-class configuration**
    ...
    * The `vectorIndexConfig` is an arbitrary object passed to the index for config (defaults can be found [here](/docs/weaviate/config-refs/schema/vector-index.md#how-to-configure-hnsw) )
