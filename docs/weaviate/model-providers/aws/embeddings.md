...
- `amazon.titan-embed-text-v1` (no longer available on AWS Bedrock)
- `amazon.titan-embed-text-v2:0`
- `cohere.embed-english-v3` (no longer available on AWS Bedrock)
- `cohere.embed-multilingual-v3` (no longer available on AWS Bedrock)
...
Any custom SageMaker name (TEI-xxx) can be used as an endpoint.
