...
You must provide a valid Weaviate Cloud API key to Weaviate for these integrations. Go to [Weaviate Cloud](/go/console?utm_source=docs&utm_content=howto/) to sign up and obtain an API key.
