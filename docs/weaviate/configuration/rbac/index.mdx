...
Weaviate provides differentiated access through [authorization](docs/deploy/configuration/authorization.md) levels based on the [authenticated](docs/deploy/configuration/authentication.md) user identity.
...
This RBAC system ensures that users only have the access necessary for their roles, enhancing both security and manageability within Weaviate. Roles and permissions can be managed through the Weaviate <b><SkipLink href="/docs/weaviate/api/rest#tag/authz">REST API</SkipLink></b> directly or through a **[client library](/docs/weaviate/configuration/rbac/manage-roles)** programmatically.
...
The `root` role can be assigned to a user through the Weaviate configuration file using the [`AUTHORIZATION_RBAC_ROOT_USERS`](docs/deploy/configuration/env-vars/index.md#rbac-authorization) environment variable. A predefined role cannot be modified. The user can, however, be assigned additional roles through the Weaviate API.
...
Refer to the [RBAC: Configuration](docs/deploy/configuration/configuring-rbac.md) page for more information on how to assign predefined roles to users.
...
Role management can be performed with a [predefined `root` role](docs/deploy/configuration/configuring-rbac.md) or a custom role with [`manage_roles` permissions](/docs/weaviate/configuration/rbac/manage-roles#role-management-permissions).
...
<table class="rbac-table">
  ...
  <tbody>
    <tr>
      <td>
        <Link to="/docs/weaviate/configuration/rbac/manage-roles#role-management-permissions">
    ...
    <tr>
      <td>
        <Link to="/docs/weaviate/configuration/rbac/manage-roles#user-management-permissions">
    ...
    <tr>
      <td>
        <Link to="/docs/weaviate/configuration/rbac/manage-roles#collections-permissions">
    ...
    <tr>
      <td>
        <Link to="/docs/weaviate/configuration/rbac/manage-roles#tenants-permissions">
    ...
    <tr>
      <td>
        <Link to="/docs/weaviate/configuration/rbac/manage-roles#data-permissions">
    ...
    <tr>
      <td>
        <Link to="/docs/weaviate/configuration/rbac/manage-roles#backups-permissions">
    ...
    <tr>
      <td>
        <Link to="/docs/weaviate/configuration/rbac/manage-roles#clusters-permissions">
    ...
    <tr>
      <td>
        <Link to="/docs/weaviate/configuration/rbac/manage-roles#nodes-permissions">
...
- [RBAC: Configuration](docs/deploy/configuration/configuring-rbac.md)
