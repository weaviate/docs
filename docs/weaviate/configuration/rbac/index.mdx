...
Role management can be performed with a [predefined `root` role](/docs/weaviate/configuration/rbac/configuration) or a custom role with [`manage_roles` permissions](/docs/weaviate/configuration/rbac/manage-roles-users#role-management-permissions).
...
<table class="rbac-table">
  ...
  <tbody>
    <tr>
      <td>
        <Link to="/docs/weaviate/configuration/rbac/manage-roles-users#role-management-permissions">
    ...
    <tr>
      <td>
        <Link to="/docs/weaviate/configuration/rbac/manage-roles-users#collections-permissions">
    ...
    <tr>
      <td>
        <Link to="/docs/weaviate/configuration/rbac/manage-roles-users#tenants-permissions">
    ...
    <tr>
      <td>
        <Link to="/docs/weaviate/configuration/rbac/manage-roles-users#data-permissions">
    ...
    <tr>
      <td>
        <Link to="/docs/weaviate/configuration/rbac/manage-roles-users#backups-permissions">
    ...
    <tr>
      <td>
        <Link to="/docs/weaviate/configuration/rbac/manage-roles-users#clusters-permissions">
    ...
    <tr>
      <td>
        <Link to="/docs/weaviate/configuration/rbac/manage-roles-users#nodes-permissions">
...
- [RBAC: Configuration](/docs/weaviate/configuration/rbac/configuration)
- [RBAC: Manage roles & users](/docs/weaviate/configuration/rbac/manage-roles-users)
- [RBAC: Tutorial](/docs/weaviate/tutorials/rbac)
