...
- **Step 1.** Connect to Weaviate with a user possessing **[role management permissions](#requirements)**
- **Step 2.** Grant permissions to a **[new role](#create-new-roles-with-permissions)** or an **[existing role](#grant-additional-permissions)**
- **Step 3.** **[Assign the role to a user](#assign-a-role-to-a-user)**
