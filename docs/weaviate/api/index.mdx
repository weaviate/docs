...
- **[Search API - GraphQL](./graphql/index.md)**: Designed specifically for data querying and exploration.
  ...
  - Not available on new Weaviate Cloud clusters. They are created with GraphQL disabled. Use a [client library](../client-libraries/index.mdx) or the [REST Search endpoints](/weaviate/api/rest) instead.
