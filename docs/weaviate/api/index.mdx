...
- **[Search API - GraphQL](./search.mdx#graphql-api)**: Designed specifically for data querying and exploration.
...
- **[Search API - gRPC](./search.mdx#grpc-api)**: A high-performance alternative for GraphQL when it comes to demanding data operations.
