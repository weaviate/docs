...
:::tip How-to guide
For usage examples with multi-language code snippets, see [Query basics: Retrieve metadata values](../../search/basics.md#retrieve-metadata-values).
:::
...
The `score` will be the hybrid score of the result, based on the nominated [fusion algorithm](../../search/hybrid.md#fusion-algorithms). Note that this score is relative to the dataset and query.
