...
For details, see [set inverted index parameters](../../manage-collections/vector-config.mdx#set-inverted-index-parameters)
...
- [Configure inverted indexes](../../manage-collections/vector-config.mdx#set-inverted-index-parameters)
