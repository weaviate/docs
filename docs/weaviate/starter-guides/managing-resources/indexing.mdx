...
[Asynchronous vector indexing](/weaviate/config-refs/schema/vector-index#asynchronous-indexing) allows you to import objects into Weaviate without waiting for the HNSW index to be built.
...
For details, see [set inverted index parameters](/weaviate/manage-data/collections#set-inverted-index-parameters)
...
- [Configure vector indexes](/weaviate/config-refs/schema/vector-index)
- [Configure inverted indexes](/weaviate/manage-data/collections#set-inverted-index-parameters)
