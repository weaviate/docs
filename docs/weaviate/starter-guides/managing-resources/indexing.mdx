...
[Asynchronous vector indexing](/weaviate/config-refs/vectorization.mdx#asynchronous-indexing) allows you to import objects into Weaviate without waiting for the HNSW index to be built.
...
- [Configure vector indexes](/weaviate/config-refs/vectorization.mdx)
