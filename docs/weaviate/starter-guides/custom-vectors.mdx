...
Weaviate is open source. You can [run Weaviate](/docs/deploy/index.mdx) locally, in the cloud, or as a service. If you want to follow this guide without setting up an instance of your own, consider using a free, Sandbox instance in [Weaviate Cloud](/docs/cloud/quickstart).
