...
Weaviate is open source. You can [run Weaviate](/docs/weaviate/installation) locally, in the cloud, or as a service. If you want to follow this guide without setting up an instance of your own, consider using a free, Sandbox instance in [Weaviate Cloud](/docs/wcs/quickstart).
...
If you are using a Sandbox instance, the URL and API keys are listed in the [details panel](/docs/wcs/quickstart#explore-the-details-panel) for your instance.
...
Weaviate stores [data](../concepts/data.md) in collections. Each data object in a collection has a set of properties and a vector representation. Before you import data, you should create a [collection definition](/docs/weaviate/config-refs/schema) to define the data properties for the collection.
