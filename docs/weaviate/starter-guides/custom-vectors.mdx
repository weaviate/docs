...
Weaviate is open source. You can [run Weaviate](/weaviate/installation) locally, in the cloud, or as a service. If you want to follow this guide without setting up an instance of your own, consider using a free, Sandbox instance in [Weaviate Cloud](/wcs/quickstart).
...
If you are using a Sandbox instance, the URL and API keys are listed in the [details panel](/wcs/quickstart#explore-the-details-panel) for your instance.
