...
If you are using a Sandbox instance, the URL and API keys are listed in the [details panel](/docs/cloud/quickstart#explore-the-details-panel) for your instance.
