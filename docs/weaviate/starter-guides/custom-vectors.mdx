...
This guide uses a Weaviate Cloud instance to host the collection. To [connect to a Weaviate Cloud instance](/docs/cloud/manage-clusters/connect), you need the following information:

- The Weaviate URL
- The Weaviate API key

If you are using a Sandbox instance, the URL and API keys are listed in the [details panel](/docs/cloud/manage-clusters/connect.mdx) for your instance.
