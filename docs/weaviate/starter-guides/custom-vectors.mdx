...
Weaviate stores [data](../concepts/data.md) in collections. Each data object in a collection has a set of properties and a vector embedding. Before you import data, you should create a [collection definition](/weaviate/config-refs/schema) to define the data properties for the collection.
