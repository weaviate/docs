...
Weaviate is open source. You can [run Weaviate](/deploy/index.mdx) locally, in the cloud, or as a service. If you want to follow this guide without setting up an instance of your own, consider using a free cluster in [Weaviate Cloud](/cloud).
...
The Python client requires Weaviate `v1.23.7` and later.<br/><br/>
