...
You can find examples of how to define and use cross-references [here](/docs/weaviate/manage-collections/cross-references).
...
We recommend that you read the [concepts page on replication](/docs/weaviate/concepts/replication-architecture) for information on how replication works in Weaviate. To specify a replication factor, follow [this how-to](../../manage-collections/multi-node-setup.mdx#replication-settings).
