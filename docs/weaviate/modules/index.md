...
- [S3](/weaviate/configuration/backups.md#s3-aws-or-s3-compatible)
- [GCS](/weaviate/configuration/backups.md#gcs-google-cloud-storage)
- [Azure](/weaviate/configuration/backups.md#azure-storage)
...
As of Weaviate `v1.16`, the only supported internal backup provider is the [filesystem](/weaviate/configuration/backups.md#filesystem) provider.
