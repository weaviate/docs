...
pagination_next: weaviate/quickstart/index
# tags: []
---
...
<div class="row">
  <div class="card">
    <div class="card__image">
      <img src={WeaviateEcosystem} alt="Weaviate Ecosystem" />
    </div>
    <div class="card__body">
      <p>Weaviate ecosystem</p>
    </div>
  </div>
</div>
<br />

The Weaviate ecosystem consists of multiple tools and services centered around building cloud native AI-powered applications. As shown in the high-level overview above, the ecosystem consists of:

- **[Weaviate Core](#what-is-weaviate)**: An open source vector database that stores both objects and vectors.
- **[Weaviate Cloud](/docs/cloud)**: A fully managed cloud deployment of the Weaviate vector database.
- **[Weaviate Agents](/docs/agents)**: Pre-built agentic services for Weaviate Cloud users.
- **[Weaviate Embeddings](/docs/cloud/embeddings)**: A managed embedding inference service for Weaviate Cloud users.
...
export const welcomeCardsData = [
  ...
  },
  {
    ...
    title: "Concepts",
    description:
      "Learn more about Weaviate with our detailed concept explanations",
