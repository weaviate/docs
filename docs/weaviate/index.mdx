...
- **[Agent-driven workflows](../query-agent/index.md)**  
...
- **[Query Agent](/query-agent)**: A pre-built agentic search service for Weaviate Cloud users.
...
export const communityCardsData = [
  ...
  },
  {
    ...
    description:
      "Direct help from the Weaviate support team for Weaviate Cloud users and customers. Open and track support tickets in the Support Portal.",
