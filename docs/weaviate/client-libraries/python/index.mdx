...
The Weaviate Python client `v3` has been deprecated and should no longer be used. If you need documentation for the `v3` client, see the [documentation archive](https://docs-archive-weaviate-io.netlify.app/weaviate/client-libraries/python/python_v3). If you are migrating from the Python `v3` client to the `v4` client, see this [migration guide](https://docs-archive-weaviate-io.netlify.app/weaviate/client-libraries/python/v3_v4_migration).
