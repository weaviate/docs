...
The TypeScript client is version `v||site.typescript_client_version||`. Use the [TypeScript v3 client](/weaviate/client-libraries/typescript/typescript-v3) for new projects.
:::
