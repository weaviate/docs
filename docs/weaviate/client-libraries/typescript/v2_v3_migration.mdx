...
For more information on batch processing, see [Batch Inserts](/docs/weaviate/client-libraries/typescript/typescript-v3#batch-inserts).
...
- [Data management](/docs/weaviate/manage-data)
...
1. Edit your v2 code to [import](/docs/weaviate/client-libraries/typescript/typescript-v3#import-the-client) the v3 client package.
1. Edit your v2 [client instantiation](/docs/weaviate/client-libraries/typescript/typescript-v3#connect-to-weaviate) code.
1. Edit your code to reflect the [collection first](/docs/weaviate/client-libraries/typescript/typescript-v3#design-philosophy) client orientation.
