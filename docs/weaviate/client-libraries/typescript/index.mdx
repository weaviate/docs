...
The [v2 client](./typescript-v2.mdx) version is still available in [npm](https://www.npmjs.com/package/weaviate-ts-client?activeTab=versions), however you should not use it to begin new projects except if you need browser based web client development.
...
If you want to dive straight into demo applications and code examples that use the client, please take a look at the **[example code](#code-examples--further-resources)** section of this page.
:::
