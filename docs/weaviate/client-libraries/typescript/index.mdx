...
The Weaviate JavaScript/TypeScript client `v2` has been deprecated and should no longer be used. If you need documentation for the `v2` client, see the [documentation archive](https://docs-archive-weaviate-io.netlify.app/weaviate/client-libraries/typescript/typescript-v2). If you are migrating from the JavaScript/TypeScript `v2` client to the `v3` client, see this [migration guide](https://docs-archive-weaviate-io.netlify.app/weaviate/client-libraries/typescript/v2_v3_migration).
