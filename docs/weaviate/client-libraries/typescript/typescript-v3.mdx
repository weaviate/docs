...
The TypeScript client is version `v||site.typescript_client_version||`. Use the [TypeScript v3 client](/docs/weaviate/client-libraries/typescript/typescript-v3) for new projects.
:::
...
[Embedded Weaviate](/weaviate/installation/embedded) is not supported in the v3 client. The v2 client supports embedded Weaviate.
