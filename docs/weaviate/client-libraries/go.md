...
All [RESTful endpoints](/docs/weaviate/api/rest) and [GraphQL functions](/docs/weaviate/api) references covered by the Go client, and explained on those reference pages in the code blocks.
