...
The Weaviate Java client `v5` has been deprecated and should no longer be used. If you need documentation for the `v5` client, see the [documentation archive](https://archive.docs.weaviate.io/weaviate/client-libraries/java/java-v5). 
