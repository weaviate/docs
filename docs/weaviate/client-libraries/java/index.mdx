...
:::info New Java client library

We are working on a revamped Java client library with a completely new API.  
Check out the [Java client v6 - Beta release](./java-v6.mdx).
