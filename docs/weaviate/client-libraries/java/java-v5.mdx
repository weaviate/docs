...
:::caution Java v5 will be deprecated

The [Java client v6](./index.mdx) has been released. New Weaviate features will no longer be supported by the v5 client and we advise switching to the v6 client.
...
The latest Java v5 client is version `v5.5.0`.
