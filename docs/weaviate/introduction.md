...
You can add data to Weaviate through the [RESTful API](/weaviate/api/rest) end-points and retrieve data through the [GraphQL interface](./api/graphql/index.md).
