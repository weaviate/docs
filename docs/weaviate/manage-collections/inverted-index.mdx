...
Property-level [inverted index parameters](../config-refs/indexing/inverted-index.mdx#inverted-index-parameters) control how individual properties are indexed for search and filtering operations. These parameters determine whether specific properties can be searched, filtered, or used in range queries.
