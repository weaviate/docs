...
import JavaV6Code from "!!raw-loader!/_includes/code/howto/java/src/test/java/io/weaviate/docs/manage-data.classes-v6.java";
...
Using too many collections can lead to scalability issues like high memory usage and degraded query performance. Instead, consider [using multi-tenancy](/docs/weaviate/manage-collections/multi-tenancy), where a single collection is subdivided into multiple tenants.
...
- <SkipLink href="/docs/weaviate/api/rest#tag/schema">
...
- <SkipLink href="/docs/weaviate/api/rest#tag/schema/post/schema">
    API References: REST: Schema
  </SkipLink>
