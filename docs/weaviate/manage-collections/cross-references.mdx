...
description: "Create and manage cross-references between collections with code in Python, TypeScript, Go, Java, and C#."
---
...
:::info References are not returned by default
A query never returns cross-referenced data unless you ask for it. Request it explicitly with `return_references`, `returnReferences`, or similar. If your results have no references in them, this is usually why. See [Read cross-references](#read-cross-references) below.
:::
