...
Not every setting can be changed after a collection exists. For what you can change, and what needs a new collection, see [Collection definition: Mutability](/weaviate/config-refs/collections#mutability).
