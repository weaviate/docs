...
export const specificGuidesData = [
  ...
  },
  {
    ...
    link: "/docs/weaviate/manage-collections/generative-reranker-models",
  ...
  <ul>
    <li>
      ...
      <ul>
        <li>
          ...
          meaning. (See the{" "}
          <Link to="/docs/weaviate/manage-objects">
    ...
    <li>
      ...
      <ul>
        <li>
          <b>
            <Link to="/docs/weaviate/manage-collections/vector-config">
        ...
        <li>
          <b>
            <Link to="/docs/weaviate/manage-collections/generative-reranker-models">
              Generative models
            </Link>
          </b>
    ...
    <li>
      ...
      <ul>
        <li>
          <b>
            <Link to="/docs/weaviate/manage-collections/collection-operations#set-inverted-index-parameters">
              Inverted index
            </Link>
          </b>
        ...
        <li>
          <b>
            <Link to="/docs/weaviate/manage-collections/multi-tenancy">
              Multi-tenancy
            </Link>
          </b>
