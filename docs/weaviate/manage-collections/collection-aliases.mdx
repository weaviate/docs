...
On namespace-enabled clusters (`v1.38`+ Preview), aliases are scoped to a namespace — an alias resolves to a collection in the same namespace; cross-namespace aliases are not supported. See [Namespaces](../concepts/namespaces.md).
