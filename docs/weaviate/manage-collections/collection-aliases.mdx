...
On namespace-enabled clusters, aliases are scoped to a namespace — an alias resolves to a collection in the same namespace, and cross-namespace aliases are not supported. See [Namespaces](../concepts/namespaces.md).
