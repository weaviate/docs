...
Once created, aliases can be used instead of collection names in all object-related operations, like data import and querying. Aliases cannot be used to update collection definitions or to delete collections. 
