...
The [Query application (query tool)](/docs/wcs/tools/query-tool) is a browser-based GraphQL IDE. The Query tool is available in the Weaviate Cloud (WCD) console.
...
import QueryAppExample from '/docs/wcs/img/query-app-example.jpg';
