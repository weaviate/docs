...
import JavaV6Code from '!!raw-loader!/_includes/code/connections/connect-v6.java';
...
For additional client examples, see [OIDC authentication](/docs/weaviate/connections/connect-custom#oidc-authentication).
