...
Follow these steps to connect to a [Weaviate Cloud (WCD)](/go/console?utm_source=docs&utm_content=howto/) instance.

## Retrieve your API key and REST endpoint

Open the [Weaviate Cloud console](/go/console?utm_source=docs&utm_content=howto/) and follow the steps below:
