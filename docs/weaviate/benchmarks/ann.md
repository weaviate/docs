...
For good starting point values and performance tuning advice, see [HNSW Configuration Tips](https://weaviate.io/docs/weaviate/config-refs/schema/vector-index#hnsw-configuration-tips).
:::
...
For more instructions on how to tune your configuration for best performance, see [HNSW Configuration Tips](https://weaviate.io/docs/weaviate/config-refs/schema/vector-index#hnsw-configuration-tips).
...
parameters](/docs/weaviate/config-refs/schema/vector-index.md#how-to-configure-hnsw).
