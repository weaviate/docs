...
Find out more about error handling on the Python client [reference page](/docs/weaviate/client-libraries/python#error-handling).
...
The Python client uses gRPC by default. See the client page for additional batch import [configuration options](/docs/weaviate/client-libraries/python#batch-imports).
...
The [TypeScript client v3](/docs/weaviate/client-libraries/typescript/typescript-v3#batch-inserts) uses gRPC by default.
...
- [Python client `v4`](../client-libraries/python/index.md#batch-imports)
...
To maximize import speed, enable [asynchronous indexing](/docs/weaviate/config-refs/schema/vector-index#asynchronous-indexing).
...
For details, see [auto-tenant](/docs/weaviate/manage-data/multi-tenancy#automatically-add-new-tenants).
...
- <SkipLink href="/docs/weaviate/api/rest#tag/batch">References: REST - /v1/batch</SkipLink>
- [Configuration: Indexes](/docs/weaviate/config-refs/schema/vector-index#asynchronous-indexing)
