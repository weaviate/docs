...
The Python client uses gRPC by default. See the client page for additional batch import [configuration options](/weaviate/client-libraries/python#batch-imports).
...
The [TypeScript client v3](/weaviate/client-libraries/typescript/typescript-v3#batch-inserts) uses gRPC by default.
...
To maximize import speed, enable [asynchronous indexing](/weaviate/config-refs/schema/vector-index#asynchronous-indexing).
...
For details, see [auto-tenant](/weaviate/manage-data/multi-tenancy#automatically-add-new-tenants).
...
- [References: REST - /v1/batch](/weaviate/api/rest#tag/batch)
- [Configuration: Indexes](/weaviate/config-refs/schema/vector-index#asynchronous-indexing)
