...
- [Vectorizer configuration references](/weaviate/config-refs/schema#vectorizer)
...
- [Replication](/weaviate/config-refs/schema#replicationconfig)
...
- [Sharding](/weaviate/config-refs/schema#shardingconfig)
