...
Using too many collections can lead to scalability issues like high memory usage and degraded query performance. Instead, consider [using multi-tenancy](/docs/weaviate/manage-data/multi-tenancy), where a single collection is subdivided into multiple tenants. 

For more details, see [Starter Guides: Scaling limits with collections](/docs/weaviate/starter-guides/managing-collections/collections-scaling-limits).
:::
<!--
...
- [References: Configuration: Schema](/docs/weaviate/config-refs/schema)
- <SkipLink href="/docs/weaviate/api/rest#tag/schema">API References: REST: Schema</SkipLink>
...
- [Replication](/docs/weaviate/config-refs/schema#replicationconfig)
...
- [Sharding](/docs/weaviate/config-refs/schema#shardingconfig)
...
- <SkipLink href="/docs/weaviate/api/rest#tag/schema/post/schema">API References: REST: Schema</SkipLink>
- [References: Configuration: Schema](/docs/weaviate/config-refs/schema)
...
- [Tutorial: Schema](../starter-guides/managing-collections/index.mdx)
