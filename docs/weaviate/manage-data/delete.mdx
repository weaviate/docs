...
Objects must belong to a collection in Weaviate. Accordingly, <a href="/weaviate/manage-data/collections#delete-a-collection">deleting collections</a> will remove all objects within them.
