...
Objects must belong to a collection in Weaviate. Accordingly [deleting collections](/docs/weaviate/manage-data/collections#delete-a-collection) will remove all objects within them.
