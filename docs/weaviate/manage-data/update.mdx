...
<details>
  ...
  - Partial updates use [`PATCH` requests to the `/v1/objects` REST API endpoint](/docs/weaviate/api/rest#tag/objects/patch/objects/%7BclassName%7D/%7Bid%7D) under the hood.
  - Complete updates use [`PUT` requests to the `/v1/objects` REST API endpoint](/docs/weaviate/api/rest#tag/objects/put/objects/%7BclassName%7D/%7Bid%7D) under the hood.
...
- [References: REST - /v1/objects](/docs/weaviate/api/rest#tag/objects/put/objects/%7BclassName%7D/%7Bid%7D)
