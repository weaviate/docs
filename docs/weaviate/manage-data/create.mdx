...
Before you create an object, you can [validate](/docs/weaviate/api/rest#tag/objects/post/objects/validate) it against the collection definition.
...
- [References: REST - /v1/objects](/docs/weaviate/api/rest#tag/objects)
