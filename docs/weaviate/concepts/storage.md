...
* A vector index store (plugable, currently a [custom implementation of HNSW](/weaviate/concepts/vector-index.md#hierarchical-navigable-small-world-hnsw-index))
