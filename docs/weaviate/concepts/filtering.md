...
The cutoff value can be configured as [part of the `vectorIndexConfig` settings in the schema](/weaviate/config-refs/vectorization.mdx#hnsw-indexes) for each collection separately.
