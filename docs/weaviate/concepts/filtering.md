...
The cutoff value can be configured as [part of the `vectorIndexConfig` settings in the schema](/weaviate/config-refs/schema/vector-index.md#how-to-configure-hnsw) for each collection separately.
