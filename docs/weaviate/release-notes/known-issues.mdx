...
This page documents significant known issues in Weaviate, their symptoms, and recommended resolutions. Use the table below to find issues relevant to your version.

## Quick Reference

| Issue | Affected Versions | Resolution | Fixed In |
|-------|-------------------|--------|----------|
| [Multiple vectors with quantization](#multiple-vectors-with-quantization) | 1.25.0-1.33.0 | In progress | - |
...
### Multiple Vectors with Quantization
