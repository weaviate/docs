---
title: Setting up RBAC in Weaviate
...
import RbacGoV6Code from '!!raw-loader!/_includes/code/go-v6/rbac_test.go';
...
![RBAC Tutorial Diagram](./_includes/rbac-tutorial-diagram.png)
...
- A preferred Weaviate [client library](/weaviate/client-libraries/index.mdx) installed.
...
:::info The environment variables in this configuration will:
...
:::info
<details>
  <summary> RBAC specific environment variables </summary>
...
More environment variables can be found [here](/deploy/configuration/env-vars/index.md).
</details>
