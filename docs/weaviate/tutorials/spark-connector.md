...
If using an authenticated cluster such as on [WCD](../../cloud/quickstart.mdx) you can provide `.option("apiKey", WEAVIATE_API_KEY)` for api key authentication like below:
