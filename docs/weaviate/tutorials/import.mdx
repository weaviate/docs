...
- An instance of Weaviate (e.g. on [Weaviate Cloud](/go/console?utm_source=docs&utm_content=tutorial), or locally), version `v1.33` or newer for server-side batching
