...
- An instance of Weaviate (e.g. on [Weaviate Cloud](https://console.weaviate.cloud), or locally), version `v1.33` or newer for server-side batching
...
We'll use a small Jeopardy dataset for this tutorial. Download it to your working directory:

[Download jeopardy_tiny.json](https://raw.githubusercontent.com/weaviate-tutorials/quickstart/main/data/jeopardy_tiny.json)
...
## Tutorial: Importing data with batching
...
## Option A: Server-side batching (Recommended)

:::caution Preview

Server-side batching was added in **`v1.33`** as a **preview**.<br/><br/>
...
- [API Reference: Batch operations](/weaviate/api/rest#tag/batch)
