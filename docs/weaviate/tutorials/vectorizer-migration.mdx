...
- A [Weaviate Cloud](/go/console?utm_source=docs&utm_content=tutorial) instance (version `v1.32` or newer)
...
Sign up for a free Weaviate Cloud sandbox at [console.weaviate.cloud](/go/console?utm_source=docs&utm_content=tutorial)
