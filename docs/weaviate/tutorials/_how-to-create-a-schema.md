...
- The schema can be modified through the [RESTful API](/weaviate/api/rest#tag/schema). Python, JavaScript and Go clients are available.
- A class or property in Weaviate becomes immutable, but can always be extended.
- Learn about Concepts, Classes, Properties and dataTypes in the [API reference guide](/weaviate/api/index.md).
...
- Check out the [RESTful API reference](/weaviate/api/rest#tag/schema) for an overview of all schema API operations.
