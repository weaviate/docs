...
Configure replication settings, such as [async replication](/docs/weaviate/configuration/replication#async-replication-settings) and [deletion resolution strategy](docs/weaviate/concepts/replication-architecture/consistency.md#deletion-resolution-strategies).
