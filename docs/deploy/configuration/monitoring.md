...
| `weaviate_self_recovery_no_data_during_bootstrap_total` | Empty shards created on a wiped node. This usually means a collection or tenant was created while the node was away, not data loss. | None   | `Counter`   |
