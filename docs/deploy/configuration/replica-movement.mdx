...
To learn more about the replication states, check out [Concepts: Cluster architecture](/docs/weaviate/concepts/replication-architecture/cluster-architecture.md#replica-movement).
...
- [Concepts: Cluster architecture](/docs/weaviate/concepts/replication-architecture/cluster-architecture.md#replica-movement)
