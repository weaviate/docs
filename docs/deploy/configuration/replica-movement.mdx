...
:::info Enable replica movement

Replica movement is disabled by default. To use this feature, set the [`REPLICA_MOVEMENT_ENABLED`](/docs/deploy/configuration/env-vars/index.md#REPLICA_MOVEMENT_ENABLED) environment variable to `true` on all nodes in your cluster.
