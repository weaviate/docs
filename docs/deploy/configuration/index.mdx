...
export const clusterInfoData = [
  ...
  },
  {
    ...
    description: "Collect Prometheus metrics to monitor the health and performance of your Weaviate instance.",
    link: "/deploy/configuration/monitoring",
    icon: "fas fa-chart-bar",
  },
  {
    title: "Logging",
    description: "Configure log levels, formats, and audit logging for operational visibility and troubleshooting.",
