...
When RBAC is enabled, Weaviate automatically logs all authorization decisions for security auditing. See [Logging: Authorization audit logging](./logging.md#authorization-audit-logging) for details.
