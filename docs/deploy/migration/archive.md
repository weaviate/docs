...
1. **Per-class configuration**
    ...
    * The `vectorIndexConfig` is an arbitrary object passed to the index for config (defaults can be found [here](/weaviate/config-refs/vectorization.mdx#hnsw-indexes) )
