...
For client library specific changes, take a look at the change logs of the specific client ([Go](/weaviate/client-libraries/go/index.md#releases), [Python](/weaviate/client-libraries/python/index.mdx#releases) and [TypeScript/JavaScript](/weaviate/client-libraries/typescript/index.mdx#releases).
