...
export const deploymentCardsData = [
  ...
  },
  {
    ...
    header: "DigitalOcean",
    bgImage: "/img/site/digitalocean.svg",
    bgImageLight: "/img/site/digitalocean.svg",
    listItems: [
    ...
    button: {
      text: "Deploy Weaviate on DigitalOcean",
      link: "/deploy/installation-guides/digitalocean",
    },
  },
];
