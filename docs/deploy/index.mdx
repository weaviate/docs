...
export const deploymentCardsData = [
  ...
  },
  {
    ...
    header: "AWS",
    bgImage: "/docs/img/site/aws-marketplace-2.svg",
    bgImageLight: "/docs/img/site/aws-marketplace-2.svg", 
    listItems: [
      "From evaluation (sandbox) to production",
    ...
    button: {
      ...
      link: "/docs/deploy/installation-guides/aws-marketplace",
    },
  },
  {
    tabs: [
    ...
    bgImage: "/docs/img/site/gcp-marketplace.svg",
    bgImageLight: "/docs/img/site/gcp-marketplace.svg",
    listItems: [
      "From evaluation (sandbox) to production",
