...
Ensure you are connected to Weaviate with a user possessing sufficient permissions to manage roles. You can achieve this by either using the predefined `root` role during [Weaviate configuration](docs/deploy/configuration/configuring-rbac.md) or by granting a user the [`manage_roles` permission](docs/weaviate/configuration/rbac/manage-roles.mdx#role-management-permissions).
...
You can achieve this by either using the predefined `root` role during [Weaviate configuration](/docs/deploy/configuration/configuring-rbac) 
...
Ensure you are connected to Weaviate with a user possessing sufficient permissions to manage roles. 
You can achieve this by either using the predefined `root` role during [Weaviate configuration](docs/deploy/configuration/configuring-rbac.md) 
