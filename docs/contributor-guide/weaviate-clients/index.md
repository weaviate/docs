...
* [Python](/weaviate/client-libraries/python/index.md)
...
2. Every client *must* reflect all functions of [GraphQL API](/weaviate/api/graphql/index.md) (1-1 where possible).
