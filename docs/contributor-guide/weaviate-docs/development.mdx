...
[Vector indexing](../concepts/vector-indexing.md)
...
**Use absolute paths** for cross-section linking and reusable components:
...
<!-- In reusable components that appear in multiple sections -->

[Installation guide](/weaviate/installation/index.md)
```
...
<SkipLink to="https://docs.weaviate.io/api/scalar/weaviate/reference.html#operation/objects.create">
