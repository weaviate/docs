...
As a customer or cloud user, you get access to the **Weaviate Support Portal**, a single place to open tickets, add details or attachments, and track the status and replies for each request. Tickets are automatically prioritized by severity and answered by the support team in line with your support plan's SLA.

To open a support ticket with the Weaviate team:

- **Support Portal (recommended):** Create and track tickets in the [Support Portal](https://support.weaviate.io). Add any details or attachments, and follow the status and replies for each request in one place.
- **Email:** Prefer email? Contact [support@weaviate.io](mailto:support@weaviate.io) to open a ticket. Include your organization name, cluster details, and a clear description of the issue so we can prioritize and resolve it faster.
...
Free sandbox clusters are intended for evaluation and learning. For production workloads, use a paid Weaviate Cloud plan so that support and SLAs apply.
:::
