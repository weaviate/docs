...
_test_history = []
_test_response = chat_anthropic(
    "Hello, my name is Alice.", _test_history, _anthropic_client
)
assert (
    len(_test_history) == 2
...
_test_response_2 = chat_anthropic("What is my name?", _test_history, _anthropic_client)
assert (
    len(_test_history) == 4
...
_test_history_oai = []
_test_response_oai = chat_openai(
    "Hello, my name is Bob.", _test_history_oai, _openai_client
)
assert (
...
_test_response_oai_2 = chat_openai(
    "What is my name?", _test_history_oai, _openai_client
)
assert (
