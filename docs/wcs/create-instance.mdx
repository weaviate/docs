...
When you develop your client application, use an API key to connect your client to the cluster. For more details, see [authentication](/docs/weaviate/configuration/authentication).
...
For more details on WCD versioning, see [Cluster server version](/docs/wcs/platform/version).
