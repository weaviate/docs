...
import ExplorerImg1 from '/docs/wcs/img/explorer-1.png';
import ExplorerImg2 from '/docs/wcs/img/explorer-2.png';
...
Once you've selected a cluster, you can dive into your [collections](/docs/weaviate/concepts/data.md#collections) and examine its [objects](/docs/weaviate/concepts/data.md#data-object-concepts).

import ExplorerImg3 from '/docs/wcs/img/explorer-3.png';
import ExplorerImg4 from '/docs/wcs/img/explorer-4.png';
import ExplorerImg5 from '/docs/wcs/img/explorer-5.png';
...
<div class="row">
    <div class="card">
        ...
        <div class="card__body">
            ...
            <br/>
            <p>Vectors are shown initially by its name where <a href="/docs/weaviate/concepts/data#multiple-vectors-named-vectors">named vectors</a> are used and number of dimensions. Expand the item further to see some of the vectors, or click `copy` (item <span class="callout">10</span>) to copy the entire vector to clipboard.</p>
        </div>
    </div>
</div>
<br/>
...
import ExplorerImg6 from '/docs/wcs/img/explorer-6.png';
...
import ExplorerImg7 from '/docs/wcs/img/explorer-7.png';
