...
- To create a user account, follow [these steps](/wcs/platform/create-account).
...
1. Ask the user for WCD account details.
   ...
   - If the user does not have an account, [create a new account](/wcs/platform/create-account).
...
[Billing](/wcs/platform/billing.mdx) is done on an organization level.
