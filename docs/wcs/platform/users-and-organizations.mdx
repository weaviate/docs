...
import OrgSettings from '/docs/wcs/img/orgs-settings.jpg';
import OrgPulldown from '/docs/wcs/img/orgs-pulldown.jpg';
import OrgUpdateName from '/docs/wcs/img/orgs-update-name-before.jpg';
import OrgUpdateCheckMark from '/docs/wcs/img/orgs-update-name-confirm.jpg';
...
- To create a user account, follow [these steps](/docs/wcs/platform/create-account).
...
1. Ask the user for WCD account details.
   ...
   - If the user does not have an account, [create a new account](/docs/wcs/platform/create-account).
...
[Billing](/docs/wcs/platform/billing.mdx) is done on an organization level.
