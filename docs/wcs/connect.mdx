...
import APIKeyInHeader from '/docs/wcs/img/wcs-auth-header.jpg';
import CompareURLs from '/docs/wcs/img/wcs-console-url-check.jpg';
...
- [Connect with APIs.](#connect-with-an-api)
   ...
   - Use [client libraries](/docs/weaviate/client-libraries) to connect to a WCD instance.
...
The built in [Query app](/docs/wcs/tools/query-tool) connects directly to clusters in your WCD organization without any additional authentication.
...
- [Python](/docs/weaviate/client-libraries/python/index.md#authentication)
- [TypeScript/JavaScript](/docs/weaviate/client-libraries/typescript#authentication)
