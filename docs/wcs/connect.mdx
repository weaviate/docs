...
- [Connect with APIs.](#connect-with-an-api)
   ...
   - Use [client libraries](/weaviate/client-libraries) to connect to a WCD instance.
...
The built in [Query app](/wcs/tools/query-tool) connects directly to clusters in your WCD organization without any additional authentication.
...
- [Python](/weaviate/client-libraries/python/index.md#authentication)
- [TypeScript/JavaScript](/weaviate/client-libraries/typescript/typescript-v3#authentication)
